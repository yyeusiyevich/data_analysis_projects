...
| [NPS (Net Promoter Score)](---) | The customer for this research is a large telecommunications company offering services across the CIS. The company has the task to determine the current level of customer loyalty, or NPS (Net Promoter Score). We  prepare an interactive dashboard with the results of this survey. | Tableau, Data Visualization, SQL, SQlAlchemy,Telecommunications, Marketing analyst, Data Analyst, BI-analyst, Reporting Analyst, Product Analyst. |

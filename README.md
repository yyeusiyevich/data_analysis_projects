...
| [Catering Market Analysis](---) | Using open data, we analyze the catering market in Moskow to open a new restaurant network. Based on the research, we prepare a presentation for investors. | Startups, Investments, Catering, Tech-company, Marketing analyst, Data Analyst, Offline, Data Vizualization. |
